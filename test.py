...
import random
import time
import many_rectangles_brooming
import two_rectangles
...
def show_execution_time_growth():
    ...
    for amount in (100, 200, 400):
        ...
        for i in range(4):
            ...
            many_rectangles_brooming.brooming(create_rectangles(amount))
            end_time = time.time()
...
class ManyRectanglesBroomingTestCases(unittest.TestCase):
    ...
    def test_not_overlapping(self):
        self.assertEqual(many_rectangles_brooming.brooming([[(0, 0), (3, 0), (0, 2), (3, 2)]]), 1)
        self.assertEqual(many_rectangles_brooming.brooming([[(0, 0), (3, 0), (0, 2), (3, 2)],
    ...
    def test_rectangle_inside(self):
        self.assertEqual(many_rectangles_brooming.brooming([[(0, 0), (10, 0), (0, 10), (10, 10)],
                                                                         [(1, 1), (5, 1), (1, 5), (5, 5)]]), 2)
    ...
    def test_many_rectangles_overlapping(self):
        self.assertEqual(many_rectangles_brooming.brooming([[(0, 0), (3, 0), (0, 3), (3, 3)],
                                                                         [(1, -1), (4, -1), (1, 1), (4, 1)],
                                                                         [(2, 0), (5, 0), (2, 2), (5, 2)]]), 3)
    ...
    def test_different_layer_depth_inside_rectangle(self):
        self.assertEqual(many_rectangles_brooming.brooming([[(0, 0), (7, 0), (0, 6), (7, 6)],
                                                                         [(1, 1), (2, 1), (1, 2), (2, 2)],
                                                                         [(3, 2), (6, 2), (3, 5), (6, 5)],
                                                                         [(4, 3), (5, 3), (4, 4), (5, 4)]]), 3)

    def test_different_layer_depth_inside_and_outside_of_rectangle(self):
        self.assertEqual(many_rectangles_brooming.brooming([[(0, 0), (17, 0), (0, 14), (17, 14)],
                                                                         [(1, 1), (2, 1), (1, 7), (2, 7)],
                                                                         [(1, 9), (2, 9), (1, 11), (2, 11)],
                                                                         [(3, 9), (5, 9), (3, 11), (5, 11)],
                                                                         [(4, 10), (8, 10), (4, 13), (8, 13)],
    ...
    def test_random_rectangle_input(self):
        amount = 1000
        start_time = time.time()
        many_rectangles_brooming.brooming(create_rectangles(amount))
        end_time = time.time()
...
class TwoRectanglesTestCases(unittest.TestCase):
    ...
    def test_not_overlapping(self):
        self.assertEqual(two_rectangles.rectangles_comparison([[(0, 0), (5, 0), (0, 5), (5, 5)],
                                                              [(6, 0), (12, 0), (6, 5), (12, 5)]]), 0)
    ...
    def test_rectangle_a_inside_rectangle_b(self):
        self.assertEqual(two_rectangles.rectangles_comparison([[(1, 1), (4, 1), (1, 4), (4, 4)],
                                                              [(0, 0), (5, 0), (0, 5), (5, 5)]]), 3)
